...
ifeq ($(config),releasewithsymbols_x86_64)
  ...
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx64.dll
  OBJDIR = x86_64/ReleaseWithSymbols/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DNDEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  ...
  ALL_LDFLAGS += $(LDFLAGS) -m64 -dynamiclib -Wl,-install_name,@rpath/gmcl_browser_fix_osx64.dll -mmacosx-version-min=10.7 -stdlib=libc++
...
ifeq ($(config),releasewithsymbols_x86)
  ...
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx.dll
  OBJDIR = x86/ReleaseWithSymbols/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DNDEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  INCLUDES += -I../../../source -I../../../include -isystem ../../../../garrysmod_common/include -isystem ../../../../garrysmod_common/helpers/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -m32 -dynamiclib -Wl,-install_name,@rpath/gmcl_browser_fix_osx.dll -mmacosx-version-min=10.7 -stdlib=libc++
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x86_64)
  ...
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx64.dll
  OBJDIR = x86_64/Release/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DNDEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  INCLUDES += -I../../../source -I../../../include -isystem ../../../../garrysmod_common/include -isystem ../../../../garrysmod_common/helpers/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -m64 -flto -dynamiclib -Wl,-install_name,@rpath/gmcl_browser_fix_osx64.dll -mmacosx-version-min=10.7 -stdlib=libc++
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx.dll
  OBJDIR = x86/Release/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DNDEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  INCLUDES += -I../../../source -I../../../include -isystem ../../../../garrysmod_common/include -isystem ../../../../garrysmod_common/helpers/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -m32 -flto -dynamiclib -Wl,-install_name,@rpath/gmcl_browser_fix_osx.dll -mmacosx-version-min=10.7 -stdlib=libc++
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),debug_x86_64)
  ...
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx64.dll
  OBJDIR = x86_64/Debug/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DDEBUG -D_DEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  INCLUDES += -I../../../source -I../../../include -isystem ../../../../garrysmod_common/include -isystem ../../../../garrysmod_common/helpers/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -Wundef -O0 -fPIC -fstrict-aliasing -Wstrict-aliasing=3 -g -msse2 -Wall -Wextra -mmacosx-version-min=10.7 -stdlib=libc++
...
ifeq ($(config),debug_x86)
  ...
  TARGETDIR = x86/Debug
  TARGET = $(TARGETDIR)/gmcl_browser_fix_osx.dll
  OBJDIR = x86/Debug/intermediate/gmcl_browser_fix
  DEFINES += -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DDEBUG -D_DEBUG -DGMMODULE -DBROWSER_FIX_CLIENT -DIS_SERVERSIDE=false
  INCLUDES += -I../../../source -I../../../include -isystem ../../../../garrysmod_common/include -isystem ../../../../garrysmod_common/helpers/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
clean:
	@echo Cleaning gmcl_browser_fix
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
